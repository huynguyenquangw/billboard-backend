...
VALUES
('Binh Thanh District','BT',NULL,10.810583,106.709145,(SELECT "id" from "cities" where name='Ho Chi Minh City')),
('District 7','D7',NULL,10.735719,106.727203,(SELECT "id" from "cities" where name='Ho Chi Minh City'));
